...
async def get_precip_status():
    ...
    for loc in locs:
        ...
        total_raw = float(agg[0]["total_precip"]) if agg else 0.0
        total = total_raw / 3.0
...
async def get_forecast():
    # Get latest log for a default location (e.g. Banda Aceh)
    # For now, just take the most recent log that has 'forecast_raw'
